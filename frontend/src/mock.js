...
export const portfolioData = {
  ...
  technicalWritings: [
    ...
    },
    {
      ...
      date: "April 2026",
      excerpt: "Notes on distributed optimization methods and their practical considerations in multi-agent settings.",
      readTime: "Research Paper",
      isPdf: true,
      pdfUrl: `${publicUrl}/Distributed_Optimization.pdf`
    }
  ],
